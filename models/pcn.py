...
class PCN(nn.Module):
    ...
    def __init__(self, num_dense=2048, latent_dim=512, grid_size=4):
        super().__init__()
    ...
    def forward(self, xyz):
        ...
        feature_global = feature_global.unsqueeze(2).expand(-1, -1, self.num_dense)  # (B, C, num_fine)
        feat = torch.cat([feature_global, seed, point_feat], dim=1)  # (B, C+2+3, num_fine)
